...
$("#form_setting").submit(function(){
  ...
  $.ajax({
    ...
    success: function(msg)
    {
      ...
      var simpan_online = "<?php echo 'http://resto-mudamudi.cloud-astro.com/pembelian/keterangan'?>";
      $.ajax({
        type: "POST",
        url: simpan_online,
        data: $('#form_setting').serialize(),
      ...
      $.ajax({
        ...
        $("#simpan_transaksi").click(function(){
          ...
          $.ajax({
            ...
            success: function(msg)
            {
              var simpan_transaksi_online = "<?php echo 'http://resto-mudamudi.cloud-astro.com/pembelian/simpan_transaksi/'?>";
              $.ajax({
                type: "POST",
                url: simpan_transaksi_online,
                data: $('#data_form').serialize(),
                beforeSend:function(){
                  $(".tunggu").show();  
                },
...
function add_item(){
  ...
  if(nomor_nota == '' && kode_supplier == ''){
    ...
    $.ajax({
      ...
      {
        var url_online = "http://resto-mudamudi.cloud-astro.com/pembelian/simpan_item_temp/";
        $.ajax({
          type: "POST",
          url: url_online,
          data: { kode_pembelian:kode_pembelian,
...
function update_item(){
  ...
  $.ajax({
    ...
    success: function(data)
    {
      var url_online = "<?php echo 'http://resto-mudamudi.cloud-astro.com/pembelian/update_item_temp/'?> ";
      $.ajax({
        type: "POST",
        url: url_online,
        data: { kode_pembelian:kode_pembelian,
...
function delData() {
  ...
  $.ajax({
    ...
    success: function(msg) {
      var url_online = '<?php echo 'http://resto-mudamudi.cloud-astro.com/pembelian/hapus_bahan_temp'; ?>/delete';
      $('#bahan-delete').val(msg.kode_bahan);
      var bahan = $('#bahan-delete').val();
      $.ajax({
        type: "POST",
        url: url_online,
        data: {
          bahan:bahan, kode_pembelian:kode_pembelian
        },
        success: function(msg2) {
          $(".tunggu").hide();
        }
