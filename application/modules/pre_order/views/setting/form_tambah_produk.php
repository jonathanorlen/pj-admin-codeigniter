          ...
          <div class="box-body">                   
            ...
            <form id="data_form" method="post">
              ...
              <div class="form-group  col-xs-6">
                ...
                <input id="nama_bahan_baku"  value="<?php echo @$hasil_bahan_baku->nama_bahan_baku; ?>" type="text" class="form-control" name="nama_bahan_baku" />
              </div>
              <div class="form-group  col-xs-6">
            ...
            <div class="form-group  col-xs-6">
              ...
              ?>
              <select name="kode_rak" id="kode_rak" class="form-control select2">
            ...
            <div class="form-group  col-xs-6">
              ...
              <select id="id_satuan_stok"  class="form-control stok select2" name="id_satuan_stok">
              ...
              <div class="form-group  col-xs-6">
                ...
                <input <?php  if(!empty($param)){ echo 'readonly';}?> type="text" class="form-control" name="hpp" value="<?php echo @$hasil_bahan_baku->hpp ?>" />
              </div>
              
              <div class="form-group  col-xs-6">
                <label class="gedhi"><b>QTY Grosir</label>
                <input  type="text" class="form-control" name="qty_grosir" value="<?php echo @$hasil_bahan_baku->qty_grosir ?>" />
              ...
              <div class="form-group  col-xs-6">
                ...
                <select  class="form-control select2" name="status_opname">
        ...
        <?php }else{ ?>
          ...
          success : function(data) {
            ...
            if(data==1){
              ...
              setTimeout(function(){$('.sukses').html('');window.location = "<?php echo base_url() . 'pre_order/pendaftaran' ?>";},1000);  
            }
            else{
             $(".sukses").html(data);
           }
