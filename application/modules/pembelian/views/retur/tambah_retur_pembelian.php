              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Kode Pembelian" name="nomor_nota" id="nomor_nota" readonly/>
                  </div>
                  <div class="form-group">
    ...
    <div class="modal-content">
      <form id="cari_nota" method="post">
        <div class="modal-header" style="background-color:grey">
          ...
          <h4 class="modal-title" style="color:#fff;">Transaksi Retur Pembelian</h4>
        </div>
        <div class="modal-body" >
          <div class="form-body">
           ...
           <div class="row">
            <div class="col-md-12">
              <div class="form-group">
                ...
                <input type="text" id="nota" name="nota" class="form-control" placeholder="" required="">
              </div>
            </div>
          </div>
          <div class="row">
...
$(document).ready(function(){
  ...
  $("#cari_nota").submit(function(){
    ...
    $.ajax({
      type: "POST",
      url: cari_nota,
      data: {nota:nota,kode_retur:kode_retur},
      success: function(msg)
      {
        ...
        var nota = data[1];
                ...
                if(num > 0){  
                  ...
                  $(".gagal").html('<div class="alert alert-danger">Kode Transaksi Tidak Ditemukan</div>');
                  setTimeout(function(){
                    $('.gagal').html('');
                  },1700);              
