            ...
            <div class="box-body">
              ...
              <div class="row">
               ...
               <div class="col-md-6">
                ...
                <div class="form-group">
                  <input readonly="true" type="text" value="<?php echo $hasil_transaksi_pembelian->proses_pembayaran ?>" class="form-control" placeholder="Proses Pembayaran" name="proses_pembayaran" id="proses_pembayaran" />
                ...
                <tbody id="tabel_temp_data_transaksi">
                  ...
                  foreach($list_pembelian as $daftar){ 
                    ...
                    <tr>
                      ...
                      <td align="right"><?php echo format_rupiah(@$daftar->subtotal-@$daftar->subtotal_retur); ?></td>
                    </tr>
                    <?php 
