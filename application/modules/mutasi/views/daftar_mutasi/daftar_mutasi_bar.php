...
<div class="row">      
  ...
  <div class="col-xs-12">
    ...
    <div class="box-body">            
        ...
        <a style="padding:13px; margin-bottom:10px;width: 100px;" class="btn btn-app green" href="<?php echo base_url().'stok/bar'; ?>"><i class="fa fa-edit"></i> Stok </a>
        <a style="padding:13px; margin-bottom:10px;width: 100px;" class="btn btn-app blue" href="<?php echo base_url().'spoil/bar'; ?>"><i class="fa fa-edit"></i> Spoil </a>
  ...
  -->
  <a style="padding:13px; margin-bottom:10px;width: 100px" class="btn btn-app red" href="<?php echo base_url().'mutasi/bar'; ?>"><i class="fa fa-edit"></i> Mutasi </a>
  <a style="padding:13px; margin-bottom:10px;width: 100px" class="btn btn-warning" href="<?php echo base_url().'opname/bar'; ?>"><i class="fa fa-edit"></i> Opname </a>
  <div class="row">
