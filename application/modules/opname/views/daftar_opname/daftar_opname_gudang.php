      ...
      <div class="portlet-body">
        ...
        <div class="box-body">            
          <div class="sukses" ></div>
           <a style="padding:13px; margin-bottom:10px;width: 100px" class="btn btn-app green" href="<?php echo base_url().'stok/gudang'; ?>"><i class="fa fa-edit"></i> Stok </a>
    <a style="padding:13px; margin-bottom:10px;width: 100px" class="btn btn-app blue" href="<?php echo base_url().'spoil/gudang/01'; ?>"><i class="fa fa-edit"></i> Spoil </a>
                ...
                <tr>
                  ...
                  <td align="center">
                    ...
                    if (@$daftar->validasi == 'confirmed') {
                      ...
                      echo get_validasi_opname_gudang($param,@$daftar->kode_opname);
                    }
                    ?>
                  </td>
                </tr>
