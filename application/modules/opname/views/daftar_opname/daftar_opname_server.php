...
<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
  ...
  <div class="col-xs-12">
    ...
    <!-- <a style="padding:13px; margin-bottom:10px;" class="btn btn-app red" href="<?php echo base_url().'retur_pembelian/server'; ?>"><i class="fa fa-edit"></i> Retur </a>
 -->
