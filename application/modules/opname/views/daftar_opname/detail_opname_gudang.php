...
$(".tunggu").show();
            window.location = "<?php echo base_url().'opname/gudang'; ?>";
          });
        </script>
<script>
$(document).ready(function(){
  ...
  $('#jangan_sesuaikan').on('click',function(){
    ...
    var url = "<?php echo base_url().'opname/jangan_sesuaikan_gudang'?>";
    var form_data = {
    ...
    $.ajax({
      ...
      success: function(msg)
      {
        ...
        setTimeout(function(){$('.sukses').html('');
          window.location = "<?php echo base_url() . 'opname/gudang/'.$kode_unit; ?>";
        },1500); 
      }
    });
    return false;
  ...
  $('#sesuaikan').on('click',function(){
    var kode_opname = $('#kode_opname').val();
    var url = "<?php echo base_url().'opname/sesuaikan_gudang'?>";
    var form_data = {
      kode_opname: kode_opname
    };
    $.ajax({
