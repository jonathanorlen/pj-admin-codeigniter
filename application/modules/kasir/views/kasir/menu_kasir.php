        ...
        <div class="portlet box blue">
          ...
          <div class="box-body">                                                                 
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">  
                  ...
                  <input readonly="true" type="text" value="<?php echo $kode_trans; ?>" class="form-control" placeholder="Kode Transaksi" name="kode_penjualan" id="kode_penjualan" />
                  <input  type="hidden" value="<?php echo $user->id; ?>" class="form-control" placeholder="Petugas" name="kode_kasir" id="kode_kasir" />
                </div>
              ...
              <div class="col-md-4">
                <div class="form-group">  
                  ...
                  <input  type="date" value="<?php echo date('Y-m-d')?>" class="form-control" placeholder="Tanggal Transaksi" name="tanggal_transaksi" id="tanggal_transaksi" />
                </div>
              ...
              <div class="col-md-4">
                <div class="form-group">  
                  <label>Petugas</label>
                  <input  type="text" value="<?php echo $user->uname; ?>" class="form-control" placeholder="Petugas" name="petugas" id="petugas" />
                </div>
                ...
                <div class="form-group">  
                  ...
                  <select  onchange="get_member()" class="form-control select2" id="kode_member" name="kode_member">
                   ...
                   foreach ($hasil as $list) {
                    ?>
                    <option value="<?php echo $list->kode_member;  ?>"><?php echo $list->kode_member;  ?> - <?php echo $list->nama_member;  ?></option>
                    <?php } ?>
                  </select>
                </div>
              ...
              <div class="col-md-4">
                <div class="form-group">  
                  <label>Proyek</label>
                  <select  class="form-control select2" id="kode_proyek" name="kode_proyek">
                   <option value="">Pilih Proyek</option>
                   <?php 
                   $get_proyek=$this->db->get_where('master_proyek',array('status_proyek' =>'1'));
                   $hasil=$get_proyek->result();
                   foreach ($hasil as $list) {
                    ?>
                    <option value="<?php echo $list->kode_proyek;  ?>"><?php echo $list->nama_proyek;  ?></option>
                    <?php } ?>
                  </select>
                </div>
              ...
              <div class="col-md-4">
                <div class="form-group">  
                  ...
                  <input  type="text" value="" class="form-control" placeholder="Keterangan" name="keterangan" id="keterangan" />
                </div>
            ...
            <div class="row">
             ...
             <div class="col-md-3">
              <div class="form-group">
                ...
                <input  type="text" value="" class="form-control" placeholder="Deskripsi" name="deskripsi" id="deskripsi" />
                <input  type="hidden" value="" class="form-control" placeholder="Deskripsi" name="id_temp" id="id_temp" />
              </div>
            </div>
            <div class="col-md-2">
              <div class="form-group">  
                <label>Ukuran</label>
                <input type="text" class="form-control " placeholder="Ukuran" name="ukuran" id="ukuran" value=""  />
            ...
            <div class="col-xs-2">
              ...
              ?>
              <select  class="form-control select2 " name="kode_satuan" id="kode_satuan">
                <option selected="true" value="">--Pilih satuan --</option>
            ...
            <br><br>
            <div onclick="simpan_pesanan_temp()" id="add" class="btn purple">Add</div>
         ...
         <!--  <div id="rupiah_bayar" style="padding-left:200px;margin-top:50px;font-size:55px" class="pull-left col-md-8">
            ...
            <div style="margin-top: 10px;" class="col-md-4 pull-right" hidden>
...
function simpan_pesanan_temp(){
  var url = "<?php echo base_url().'kasir/simpan_deskripsi_temp'; ?>";
  var kode_penjualan = $("#kode_penjualan").val();
  ...
  if(ukuran < 1 || deskripsi==""){
    $(".sukses").html("<div class='alert alert-warning'>Ukuran / Deskripsi Kosong</div>");
    setTimeout(function(){$('.sukses').html('');},1500); 
    ...
    $.ajax( {
     ...
     data :{kode_penjualan:kode_penjualan,
      deskripsi:deskripsi,harga:harga,ukuran:ukuran,kode_satuan:kode_satuan,
...
function actEdit(id) {
 var kode_kasir = $("#kode_kasir").val();
 var id = id;
 var url = "<?php echo base_url().'kasir/kasir/get_deskripsi_temp'; ?>";
 $.ajax({
  type: 'POST',
  url: url,
  dataType: 'json',
  ...
  success: function(kasir){
    ...
    $("#ukuran").val(kasir.ukuran);
    $("#kode_satuan").select2().select2('val', kasir.kode_satuan);
    $("#diskon_item").val(kasir.diskon_item);
    $("#harga_satuan").val(kasir.harga_satuan);
    $("#deskripsi").val(kasir.deskripsi);
    $("#id_temp").val(kasir.id);
...
function editData(){
  ...
  var url = "<?php echo base_url().'kasir/kasir/update_deskripsi_temp'; ?>";
    //var kode_penjualan = $("#kode_penjualan").val();
    var kode_penjualan = $("#kode_penjualan").val();
  var deskripsi = $("#deskripsi").val();
  ...
  var id_temp = $("#id_temp").val();
    ...
    data :{kode_penjualan:kode_penjualan,
      deskripsi:deskripsi,harga:harga,ukuran:ukuran,kode_satuan:kode_satuan,
      kode_kasir:kode_kasir,id_temp:id_temp},
    beforeSend:function(){
      $(".tunggu").show();  
    },
    success : function(data) {
      ...
      $("#harga_satuan").val('');
      $("#id_temp").val('');
      $("#kode_satuan").select2().select2('val', '');
      $("#tb_pesan_temp").load('<?php echo base_url().'kasir/kasir/pesanan_temp/'; ?>'+kode_penjualan);
  ...
  function delData() {
    ...
    var url = '<?php echo base_url().'kasir/kasir/hapus_deskripsi_temp'; ?>/delete';
...
function bayar(){
  ...
  var kode_proyek = $("#kode_proyek").val();
 ...
 // }else{
  if(nama_member==""){
    ...
    $.ajax({
      type: 'POST',
      url: url,
      data: {kode_kasir:kode_kasir,nama_petugas:nama_petugas,id_petugas:id_petugas,
        kode_penjualan:kode_penjualan,bayar:bayar,kembalian:kembalian,grand_total:grand_total,
        kode_proyek:kode_proyek,nama_proyek:nama_proyek,keterangan:keterangan,tanggal_transaksi:tanggal_transaksi,
...
$(document).ready(function(){
  ...
  $("#cari_to").click(function(){
    ...
    var kode_penjualan = $("#kode_penjualan").val();
    var url = "<?php echo base_url().'kasir/kasir/get_taking_order/'; ?>"+kode_penjualan;
    $.ajax( {
     type:"POST", 
     url : url,  
     cache :false,
