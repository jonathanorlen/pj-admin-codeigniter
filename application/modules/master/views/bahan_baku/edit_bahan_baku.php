        ...
        <div class="col-md-3">
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <a id="simpan_ecer" onclick="simpan_bb()" style="margin-top: 25px;" class="btn btn-primary"><i class="fa fa-plus"></i>Add</a>
              <a id="update_ecer" onclick="update_bb()" style="margin-top: 25px;" class="btn btn-primary"><i class="fa fa-edit"></i>Update</a>
            </div>
          </div>
        </div>
        <div class="row">
