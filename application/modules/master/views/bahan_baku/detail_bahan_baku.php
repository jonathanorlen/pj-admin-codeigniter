      ...
      <div class="portlet-body">
        ...
        <div class="box-body">
          <div class="box-body">                   
            ...
            <form id="data_form" method="post">
              ...
              <div class="form-group col-md-3">
               <label class="gedhi"><b>Foto Produk</label>
               <div class="">

                <img width="200px" height="150px" src="<?php echo base_url().'component/upload/foto/uploads/'.$hasil_bahan_baku->foto ?>">
              </div>
            </div>
            <div class="form-group  col-xs-3">
            ...
            <div class="form-group  col-xs-6">
              ...
              <input id="nama_bahan_baku"  value="<?php echo @$hasil_bahan_baku->nama_bahan_baku; ?>" type="text" class="form-control" name="nama_bahan_baku" readonly/>
            </div>
            <div class="form-group  col-xs-3">
          ...
          <div class="form-group  col-xs-3">
            ...
            <input value="<?php echo @$hasil_unit->kode_unit; ?>" type="hidden" class="form-control" name="kode_unit" readonly/>
          </div>
          ...
          <div class="form-group  col-xs-6">
            ...
            <input  value="<?php echo @$hasil_bahan_baku->jumlah_dalam_satuan_pembelian; ?>" type="text" class="form-control" name="jumlah_dalam_satuan_pembelian" readonly/>
          </div>
          <div class="form-group  col-xs-6">
            <?php
            ...
            <div class="form-group  col-xs-6">
              ...
              <input  type="text" class="form-control" name="stok_minimal" value="<?php echo @$hasil_bahan_baku->stok_minimal ?>" readonly/>
            </div>
            <div class="form-group  col-xs-6">
              <label class="gedhi"><b>HPP</label>
              <input  type="text" class="form-control" name="hpp" value="<?php echo @$hasil_bahan_baku->hpp ?>" readonly/>
            </div>

            <div class="form-group  col-xs-6">
              <label class="gedhi"><b>QTY Grosir</label>
              <input  type="text" class="form-control" name="qty_grosir" value="<?php echo @$hasil_bahan_baku->qty_grosir ?>" readonly/>

            </div>
            <div class="form-group  col-xs-2">
              <label class="gedhi"><b>Harga 1</label>
              <input  type="text" class="form-control" name="harga_jual_1" value="<?php echo @$hasil_bahan_baku->harga_jual_1 ?>" readonly/>
            </div>

            <div class="form-group  col-xs-2">
              <label class="gedhi"><b>Harga 2</label>
              <input  type="text" class="form-control" name="harga_jual_2" value="<?php echo @$hasil_bahan_baku->harga_jual_2 ?>" readonly/>
            </div>

            <div class="form-group  col-xs-2">
              <label class="gedhi"><b>Harga 3</label>
              <input  type="text" class="form-control" name="harga_jual_3" value="<?php echo @$hasil_bahan_baku->harga_jual_3 ?>" readonly/>
            </div>

                    <!--<div class="form-group  col-xs-4">
                <label class="gedhi"><b>Jenis Produk</label>
                <select disabled="true"  class="form-control select2" name="jenis_produk" required="">
              ...
              <div class="form-group  col-xs-4">
                ...
                <select disabled="true"  class="form-control select2" name="status_opname">
            ...
            <label class="gedhi"><b>Kategori Kasir</label>
              <select disabled="true" class="form-control" name="kategori_kasir" id="kategori_kasir" required="">
              ...
              <div class="form-group  col-xs-4">
                ...
                <input readonly=""  type="text" class="form-control" name="keterangan" value="<?php echo @$hasil_bahan_baku->keterangan ?>"  />
              </div>
