...
<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
  <a class="dashboard-stat dashboard-stat-light blue-soft"  id="proyek">
    <div class="visual">
      <i class="glyphicon glyphicon-taskss" ></i>
    </div>
    <div class="details">
...
<!-- <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
  <a class="dashboard-stat dashboard-stat-light red-soft"  id="barcode">
    <div class="visual">
      <i class="glyphicon glyphicon-taskss" ></i>
    </div>
    <div class="details">
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $("#proyek").click(function(){
       $('.tunggu').show();
       window.location = "<?php echo base_url() . 'master/proyek/' ?>";
     });
