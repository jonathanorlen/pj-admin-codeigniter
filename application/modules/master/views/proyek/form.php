            ...
            <div class="box-body">            
              <div class="row">
                ...
                <div class="form-group  col-xs-6">
                  ...
                  <div class="">
                    <input readonly name="kode_proyek" value="<?php if(!empty($param)){echo @$hasil_proyek->kode_proyek; }else{ echo "PRO_".$kode_proyek;} ?>"   type="text" class="form-control" id="kode_proyek" />
                  </div>
                </div>
                    ...
                    <div class="">
                      <input name="nama_proyek" value="<?php echo @$hasil_proyek->nama_proyek ?>"  type="text" class="form-control" id="nama_proyek" />
                    </div>
                  </div>
                  ...
                  <div class="input_no_ktp form-group  col-xs-6">
                    ...
                    <div class="">
                      <input name="nama_manajer" value="<?php echo @$hasil_proyek->nama_manajer ?>"  type="text" class="form-control" id="nama_manajer" />
                    </div>
                  </div>
                  ...
                  <div class="input_alamat form-group  col-xs-6">
                    ...
                    <div class="">
                      <input name="alamat_proyek" value="<?php echo @$hasil_proyek->alamat_proyek ?>"   type="text" class="form-control" id="alamat_proyek" />
                    </div>
                  </div>


                  <div class="input_nama_bank_2 form-group  col-xs-6">
                    <label><b>Nama Bank</label>
                    <div class="">
                      <input name="nama_bank" value="<?php echo @$hasil_proyek->nama_bank ?>"  type="text" class="form-control" id="nama_bank" />
                    </div>
                  </div>

                  <div class="input_no_rekening_2 form-group  col-xs-6">
                    <label><b>No. Rekening</label>
                    <div class="">
                      <input name="no_rekening" value="<?php echo @$hasil_proyek->no_rekening ?>"  type="text" class="form-control" id="no_rekening" />
                    </div>
                  </div>
                  ...
                  <div class="input_telp form-group  col-xs-6">
                    ...
                    <div class="">
                      <input name="telp_proyek" value="<?php echo @$hasil_proyek->telp_proyek ?>"  type="text" class="form-control" id="telp_proyek" />
                    </div>
                  </div>
                  ...
                  <div class="input_keterangan form-group  col-xs-6">
                    ...
                    <div class="">
                      <input name="keterangan" value="<?php echo @$hasil_proyek->keterangan ?>"  type="text" class="form-control" id="keterangan" />
                    </div>
                  </div>
                  ...
                  <div class="input_status_proyek form-group  col-xs-6">
                    ...
                    <div class="">
                     <select class="form-control" id="status" name="status_proyek">
...
<script type="text/javascript">
  ...
  //   $('.kategori_proyek').on('change', function() {
  //     if ( this.value == 'perseorangan')
  //     //.....................^.......
  //   {

  //     $(".data_proyek").show();
  //     $(".input_nama_proyek").show();
  //     $(".input_keterangan").show();
  //     $(".input_alamat").show();
  //     $(".input_telp").show();
  //     $(".input_no_ktp").show();
  //     $(".input_status_proyek").show();
  ...
  //   {
  //     $(".data_proyek").hide();
  //     $(".input_nama_proyek").hide();
  //     $(".input_keterangan").hide();
  //     $(".input_alamat").hide();
  //     $(".input_telp").hide();
  //     $(".input_no_ktp").hide();
  //     $(".input_status_proyek").hide();
