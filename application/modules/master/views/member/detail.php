                ...
                <div class="form-group  col-xs-6">
                 ...
                 <!--<?php if (!empty($param)){ ?>
                  ...
                  <div class="form-group  col-xs-6">
                   ...
                   <div class="form-group  col-xs-6">
                    <label><b>Kategori Member</label>
                    <div class="">
                      <select class="form-control kategori_member" id="kategori_member" name="kategori_member" disabled="">
                        <option <?php echo "perseorangan" == @$hasil_member->kategori_member ? 'selected' : '' ?> value="perseorangan">Perseorangan</option>
                        <option <?php echo "lembaga" == @$hasil_member->kategori_member ? 'selected' : '' ?> value="lembaga">Lembaga</option>
                      </select>
                    </div>
                  </div>

                  <br>
                  <?php if ($hasil_member->kategori_member == 'lembaga') { ?>
                  ...
                  <div id="div-nama-lembaga"  class="input_nama_lembaga form-group  col-xs-6">
                    ...
                    <div class="">
                      <input readonly name="nama_lembaga" value="<?php echo @$hasil_member->nama_lembaga ?>"  type="text" class="form-control" id="nama_lembaga" />
                    </div>
                  </div>
                  ...
                  <div id="div-alamat-lembaga"  class="input_alamat_lembaga form-group  col-xs-6">
                    ...
                    <div class="">
                      <input readonly name="alamat_lembaga" value="<?php echo @$hasil_member->alamat_lembaga ?>"   type="text" class="form-control" id="alamat_lembaga" />
                    </div>
                  </div>
                  ...
                  <div id="div-telp-lembaga"  class="input_telp_lembaga form-group  col-xs-6">
                    ...
                    <div class="">
                      <input readonly name="telp_lembaga" value="<?php echo @$hasil_member->telp_lembaga ?>"  type="text" class="form-control" id="telp_lembaga" />
                    </div>
                  </div>
                  <?php } ?>
                  <!--LEMBAGA-->
                 ...
                 <!--  <div class="input_nama_pic form-group  col-xs-6">
                  ...
                  <div id="div-no-ktp" class="input_no_ktp form-group  col-xs-6">
                    ...
                    <div class="">
                      <input readonly name="no_ktp" value="<?php echo @$hasil_member->no_ktp ?>"  type="text" class="form-control" id="no_ktp" />
                    </div>
                  </div>
                  ...
                  <div id="div-nama-member" class="input_nama_member form-group  col-xs-6">
                    ...
                    <div class="">
                      <input readonly name="nama_member" value="<?php echo @$hasil_member->nama_member ?>"  type="text" class="form-control" id="nama_member" />
                    </div>
                  </div>
                  ...
                  <div id="div-tempat-lahir" class="input_nama_member form-group  col-xs-6">
                    ...
                    <div class="">
                      <input readonly name="tempat_lahir" value="<?php echo @$hasil_member->tempat_lahir ?>"  type="text" class="form-control" id="tempat_lahir" />
                    </div>
                  </div>
                  ...
                  <div id="div-tanggal-lahir" class="input_nama_member form-group  col-xs-6">
                    ...
                    <div class="">
                      <input readonly type="date" value="<?php echo @$hasil_member->tanggal_lahir ?>" class="form-control" placeholder="Tanggal Lahir" name="tanggal_lahir" id="tanggal_lahir"/>
                    </div>
                  </div>
                  ...
                  <div id="div-jenis-kelamin" class="input_nama_member form-group  col-xs-6">
                    ...
                    <div class="">
                      <select class="form-control kategori_member" id="jenis_kelamin" name="jenis_kelamin" disabled="">
                        <option value="" selected="">--Pilih Jenis Kelamin--</option>
                        <option <?php if(@$hasil_member->jenis_kelamin=='Laki - Laki'){ echo 'selected'; } ?> value="Laki - Laki">Laki - Laki</option>
                        <option <?php if(@$hasil_member->jenis_kelamin=='Perempuan'){ echo 'selected'; } ?> value="Perempuan">Perempuan</option>
                      </select>
                    </div>
                  </div>
                  ...
                  <div id="div-alamat-member" class="input_alamat form-group  col-xs-6">
                    ...
                    <div class="">
                      <input readonly name="alamat_member" value="<?php echo @$hasil_member->alamat_member ?>"   type="text" class="form-control" id="alamat_member" />
                    </div>
                  </div>
                  ...
                  <div id="div-keterangan" class="input_keterangan form-group  col-xs-6">
                    ...
                    <div class="">
                      <input readonly name="keterangan" value="<?php echo @$hasil_member->keterangan ?>"  type="text" class="form-control" id="keterangan" />
                    </div>
                  </div>
                  ...
                  <div id="div-nama-bank" class="input_nama_bank_2 form-group  col-xs-6">
                    ...
                    <div class="">
                      <input readonly name="nama_bank" value="<?php echo @$hasil_member->nama_bank ?>"  type="text" class="form-control" id="nama_bank" />
                    </div>
                  </div>
                  ...
                  <div id="div-no-rekening" class="input_no_rekening_2 form-group  col-xs-6">
                    ...
                    <div class="">
                      <input readonly name="no_rekening" value="<?php echo @$hasil_member->no_rekening ?>"  type="text" class="form-control" id="no_rekening" />
                    </div>
                  </div>
                  ...
                  <div id="div-telp" class="input_telp form-group  col-xs-6">
                    ...
                    <div class="">
                      <input readonly name="telp_member" value="<?php echo @$hasil_member->telp_member ?>"  type="text" class="form-control" id="telp_member" />
                    </div>
                  </div>
