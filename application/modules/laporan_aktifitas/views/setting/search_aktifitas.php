...
<tbody>
            ...
            ?>
                ...
                <td>
                    <div class="btn-group">
                        <a href="<?php echo base_url().'laporan_aktifitas/detail_pembelian/'.@$tgl_awal."/".@$tgl_akhir; ?>" title="Detail" class="btn btn-icon-only btn-circle green">
            ...
            ?>
                ...
                <td>
                    <div class="btn-group">
                        <a href="<?php echo base_url().'laporan_aktifitas/detail_po/'.@$tgl_awal."/".@$tgl_akhir; ?>" title="Detail" class="btn btn-icon-only btn-circle green">
                            <i class="fa fa-search"></i>
                        </a>
                    </div>
                </td>
            ...
            ?>
                ...
                <td>
                    <div class="btn-group">
                        <a href="<?php echo base_url().'laporan_aktifitas/detail_retur_pembelian/'.@$tgl_awal."/".@$tgl_akhir; ?>" title="Detail" class="btn btn-icon-only btn-circle green">
                            <i class="fa fa-search"></i>
                        </a>
                    </div>
                </td>
            ...
            ?>
                ...
                <td>
                    <div class="btn-group">
                        <a href="<?php echo base_url().'laporan_aktifitas/detail_mutasi/'.@$tgl_awal."/".@$tgl_akhir; ?>" title="Detail" class="btn btn-icon-only btn-circle green">
                            <i class="fa fa-search"></i>
                        </a>
                    </div>
                </td>
            ...
            ?>
                ...
                <td>
                    <div class="btn-group">
                        <a href="<?php echo base_url().'laporan_aktifitas/detail_spoil/'.@$tgl_awal."/".@$tgl_akhir; ?>" title="Detail" class="btn btn-icon-only btn-circle green">
                            <i class="fa fa-search"></i>
                        </a>
                    </div>
                </td>
            ...
            ?>
                ...
                <td>
                    <div class="btn-group">
                        <a href="<?php echo base_url().'laporan_aktifitas/detail_opname/'.@$tgl_awal."/".@$tgl_akhir; ?>" title="Detail" class="btn btn-icon-only btn-circle green">
                            <i class="fa fa-search"></i>
                        </a>
                    </div>
                </td>
            ...
            ?>
                ...
                <td>
                    <div class="btn-group">
                        <a href="<?php echo base_url().'laporan_aktifitas/detail_penjualan/'.@$tgl_awal."/".@$tgl_akhir; ?>" title="Detail" class="btn btn-icon-only btn-circle green">
                            <i class="fa fa-search"></i>
                        </a>
                    </div>
                </td>
            ...
            ?>
                ...
                <td>
                    <div class="btn-group">
                        <a href="<?php echo base_url().'laporan_aktifitas/detail_ro/'.@$tgl_awal."/".@$tgl_akhir; ?>" title="Detail" class="btn btn-icon-only btn-circle green">
                            <i class="fa fa-search"></i>
                        </a>
                    </div>
                </td>
