<div class="row">      
  ...
  #echo $pecah_kode[2];
                ...
                <div class="col-md-6">
                  <div class="form-group">  
                    <label>Kode PO</label>
                    <input type="text" class="form-control" placeholder="Kode Po" name="kode_po2" id="kode_po2" required="" readonly="true" />
                  </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="date"  class="form-control" placeholder="Tanggal barang datang" name="tgl_barang_datang" id="tgl_barang_datang"/>
                  </div>
                </div>
                <div class="col-md-12">
                 <div class="form-group">  
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="col-md-2" hidden="">
                  ...
                  <select name="kategori_bahan" id="kategori_bahan" class="form-control" >
                    <option value="" >--Pilih Jenis Barang--</option>
                    <option selected="true" value="bahan baku">Bahan Baku</option>                     
                ...
                <div class="col-md-2">
                  ...
                  <select hidden name="jenis_diskon" id="jenis_diskon" class="form-control select2">
                ...
                <div class="col-md-2">
                  ...
                  <div class="input-icon right" id="form_diskon_item">
                    <i class="fa">%</i>
                    <input type="text" name="diskon_item" id="diskon_item" class="form-control" placeholder="Diskon Persen" value="0">
                  </div>
...
<div id="modal_setting" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel3" aria-hidden="true">
  ...
  <script type="text/javascript">
    ...
    function confirm_bayar(){
      ...
      if(nomor_nota == ''){
        $(".sukses").html('<div class="alert alert-danger">Nomor Nota harus diisi.</div>');   
        setTimeout(function(){
          $('.sukses').html('');     
        },1500);
      }
    ...
    function get_termin(){
      var kode_po = $('#kode_po2').val();
      var url = "<?php echo base_url().'pembelian/get_termin'?>";
      $.ajax({
        type: "POST",
        url: url,
  ...
  $.ajax({
    ...
    success: function(msg)
    {
      ...
      if(data[0] == 1){  
        ...
        $("#kode_supplier").select2().select2('val', data[2]);
        $(".tunggu").hide();
      }
      else{
...
$('#jenis_diskon').select2().select2('val',pembelian.jenis_diskon);
$('#diskon_item').val('0');
$('#diskon_rupiah').val('0');
$("#add").hide();
$("#update").show();
