                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        $cek_kode=explode('_', $kode);
                        //echo $cek_kode[0];
                        if($cek_kode[0]=='PENJ'){
                          $transaksi_penjualan = $this->db->get_where('transaksi_penjualan_jasa',array('kode_penjualan'=>$kode));
                  ...
                  <div class="box-body">
                    <table style="font-size: 1.5em;" id="tabel_daftar" class="table table-bordered table-striped">
                      ...
                      <tbody id="tabel_temp_data_transaksi">
                        ...
                        $kode = $this->uri->segment(5);
                        if($cek_kode[0]=='PENJ'){
                          $penjualan = $this->db->get_where('opsi_transaksi_penjualan_jasa',array('kode_penjualan'=>$kode));
