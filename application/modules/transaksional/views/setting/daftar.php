                        ...
                        <h3 class="page-title">
                          ...
                          <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                              <a class="dashboard-stat dashboard-stat-light blue-soft" id="pemasukan">
                                <div class="visual">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                              <a class="dashboard-stat dashboard-stat-light red-soft"  id="pengeluaran">
                                <div class="visual">
                        ...
                        <script type="text/javascript">
                          $(document).ready(function(){
                            ...
                            $("#pengeluaran").click(function(){
                              $('.tunggu').show();
                              window.location = "<?php echo base_url() . 'pengeluaran/daftar' ?>";
                            });
