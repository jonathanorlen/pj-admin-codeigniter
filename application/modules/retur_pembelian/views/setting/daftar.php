  ...
  <div class="col-xs-12">
    ...
    <div class="portlet box blue">
      <div class="portlet-title">
        <div class="caption">
          Retur Pembelian <?php echo $position; ?>
        </div>
        <div class="tools">
      ...
      <div class="portlet-body">
        ...
        <div class="box-body">            
          <div class="sukses" ></div>
           <a style="padding:13px; margin-bottom:10px;" class="btn btn-app green" href="<?php echo base_url().'stok/'.@$position; ?>"><i class="fa fa-edit"></i> Stok </a>
    <a style="padding:13px; margin-bottom:10px;" class="btn btn-app blue" href="<?php echo base_url().'spoil/'.@$position.'/01'; ?>"><i class="fa fa-edit"></i> Spoil </a>
...
$(".tunggu").show();
            window.location = "<?php echo base_url().'stok/'.$this->uri->segment(2); ?>";
          });
        </script>
