        ...
        <form id="data_opname">
              <div id="cari_transaksi">
                ...
                <tbody id="daftar_list_stock">
                  ...
                  $get_stok = $this->db->query("SELECT * from transaksi_opname where kode_unit='$param' and validasi='confirmed' and tanggal_opname like '%$date%' order by tanggal_opname DESC");
